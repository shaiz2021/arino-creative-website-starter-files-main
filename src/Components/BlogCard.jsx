        ...
        <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5'>
            {
                blogs.slice(0, 3).map(blog => <div key={blog.id} className='relative cursor-pointer rounded-xl'>
                    ...
                    <div className='absolute bottom-0 left-0 w-full h-full bg-black/70 hover:bg-black/30 flex items-end justify-center rounded-xl '>
                        <div>
                            <p className='px-3 mb-2 text-base'>
